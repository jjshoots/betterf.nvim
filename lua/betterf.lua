...
function M.setup(opts)
    ...
    -- keymaps
    vim.keymap.set("n", conf.mappings[1], function() betterF(true) end, { noremap = true, silent = true })
    vim.keymap.set("n", conf.mappings[2], function() betterF(false) end, { noremap = true, silent = true })
end
